    ...
    <section id="slider">
      <div id="bs-carousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="item active"><a href="product.html"><img src="/Public/img/images/ad/ad-1.png" alt=""></a></div>
          <div class="item"><a href="product.html"><img src="/Public/img/images/ad/ad-2.png" alt=""></a></div>
          <div class="item"><a href="product.html"><img src="/Public/img/images/ad/ad-3.png" alt=""></a></div>
        </div>
    ...
    <section id="content">
      <div class="container">
        <div class="products-carousel products-small products">
          <div class="banner">
            <img src="/Public/img/images/30-off.png" alt="">
          </div>
          <div class="carousel">
          <?php if(is_array($newgoodsmsg)): $i = 0; $__LIST__ = $newgoodsmsg;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$newvo): $mod = ($i % 2 );++$i;?><div>
                <div class="newproduct">
                  <div class="thumbnail">
                    <a href="<?php echo U('/Home/Goods/product');?>?gid=<?php echo ($newvo["gid"]); ?>"><img alt="" style="width: 204px;" src="/Public/pic/<?php echo ($newvo["gimgarray"]); ?>"></a>
                  </div>
                  <hr>
                  <div class="title">
                    <h3><a href="#"><?php echo ($newvo["gname"]); ?></a></h3>
                    <p>by <?php echo ($newvo["gadname"]); ?></p>
                  </div>
                </div>
        ...
        <h2 class="align-center unbranded">看看别人的包</h2>
        <div class="gap-25"></div>

        <ul class="products row">
          <?php if(is_array($goodsmsg)): $i = 0; $__LIST__ = $goodsmsg;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="col-sm-3">
              <div class="product">
                <div class="thumbnail">
