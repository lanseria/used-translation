	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="demo">
					<form id="uploadForm" action="<?php echo U('Dashboard/Goods/updategood');?>" method="post" enctype="multipart/form-data">
						<div class="">
							<input type="hidden" name="gid" value="<?php echo ($goodmsg["gid"]); ?>" />
							<div class=""><span class="">物品名称:</span><input type="text" name="gname" class="" value="<?php echo ($goodmsg["gname"]); ?>"></div>
							<div class=" ">
							...
							<div class="fabu jz"><span class="">报价:</span><input type="text" name="gprice" class="" value="<?php echo ($goodmsg["gprice"]); ?>"><span class="">元</span></div>
							<div class="fabu jz"><span class="">原价:</span><input type="text" name="goldprice" class="" value="<?php echo ($goodmsg["goldprice"]); ?>"><span class="">元(必填)</span></div>
							<div class="fabu"><span class="">卖家称呼:</span><input type="text" name="gadname" class="" placeholder="例：王同学" value="<?php echo ($goodmsg["gadname"]); ?>"></div>
							<div class="fabu"><span class="">联系方式:</span><input type="text" name="gadtel" class="kuang4" placeholder="手机/QQ/微信均可" value="<?php echo ($goodmsg["gadtel"]); ?>"></div>
							<div class="liuyan"><span class="">卖家留言:</span><textarea class="" name="gdetail" cols="50" rows="5" placeholder="建议写对物品的描述或出售原因"><?php echo ($goodmsg["gdetail"]); ?></textarea></div>
