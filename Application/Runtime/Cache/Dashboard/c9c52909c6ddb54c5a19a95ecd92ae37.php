        ...
        <ul class="nav nav-list">
          ...
          <li class="<?php echo ($fac); ?>">
            <a href="<?php echo U('/Dashboard/Goods/publiced');?>?uid=<?php echo ($usermsg['uid']); ?>" class="dropdown-toggle">
              <i class="icon-edit"></i>
              <span class="menu-text"> 发布二手信息 </span>
            </a>
          </li>
        ...
        <script type="text/javascript">
          try{ace.settings.check('sidebar' , 'collapsed')}catch(e){}
        	...
        	<div class="page-content">
        		...
        		<div class="row">
        			<div class="col-xs-12">
        				<?php if(is_array($goodsmsg)): $i = 0; $__LIST__ = $goodsmsg;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-xs-12 col-sm-4">
        						<div class="widget-box">
        							...
        							<div class="widget-body">
        								<div class="widget-main">
        									<div>
        										<img src="/Public/pic/<?php echo ($vo["gimgarray"]); ?>" style="width:100%;">
        									</div>
        									<hr />
        									<div>
        										<div class="">
        											<p><span>品名:</span><span><a href="/index.php/439.html"><?php echo ($vo["gname"]); ?></a></span></p>
        											<p><span>报价:</span>¥<?php echo ($vo["gprice"]); ?></p>
        											<p><span class="">原价:</span><span class="">¥<?php echo ($vo["goldprice"]); ?></span></p>
        											<p><span class="">发布时间:</span><?php echo ($vo["gcreate_time"]); ?></p>
        											<a class="" href="<?php echo U('Dashboard/Goods/updategood');?>?gid=<?php echo ($vo["gid"]); ?>">修改</a>
        											<a class="" href="<?php echo U('Dashboard/Goods/selloffG');?>?gid=<?php echo ($vo["gid"]); ?>">下架</a>
        										</div>
        									</div>
        								</div>
        							</div>
