    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="alert alert-block alert-success">
          ...
          <i class="icon-ok green"></i>欢迎使用<strong class="green">Dashboard后台管理系统</strong> 
        </div>
        <div class="row">
          ...
          <div class="col-sm-7 infobox-container">
            <div class="infobox infobox-green  ">
              ...
              <div class="infobox-data">
                <span class="infobox-data-number"><?php echo ($goodsnum); ?>个</span>
                <div class="infobox-content">已发布宝贝</div>
              </div>
            ...
            <div class="infobox infobox-pink  ">
              ...
              <div class="infobox-data">
                <span class="infobox-data-number"><?php echo ($goodsmem); ?>人</span>
                <div class="infobox-content">预计客户</div>
              </div>
            ...
            <div class="infobox infobox-orange2  ">
              ...
              <div class="infobox-data">
                <span class="infobox-data-number"><?php echo ($goodsview); ?></span>
            ...
            <div class="infobox infobox-blue2  ">
              ...
              <div class="infobox-data">
                <span class="infobox-text">个人信息</span>
              ...
              <div class="widget-body">
                <div class="widget-main no-padding">
                  <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php if(is_array($goodsmsg)): $i = 0; $__LIST__ = $goodsmsg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                          <td><?php echo ($vo["gname"]); ?></td>
                          <td>
                            <small>
                              <s class="red">￥<?php echo ($vo["goldprice"]); ?></s>
                            </small>
                            <b class="green">￥<?php echo ($vo["gprice"]); ?></b>
                          </td>
                          <td class="hidden-480">
                            <?php if($vo["gis_selloff"] == 0 ): ?><span class="label label-info arrowed-right arrowed-in">发布中</span>
                              <?php else: ?> <span class="label label-success arrowed-in arrowed-in-right">已下架</span><?php endif; ?>
                          </td>
